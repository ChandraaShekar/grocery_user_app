...
your way out regarding this data.<br>
We request you to go through this along with our privacy overviews which
...
accounts owned by Frutte or of owners or employees of restaurants or other
merchants; private data of those who start but do not finish applications to be
drivers or delivery persons;<br>
or other personal data in connection with our navigation technology and
features.</span></p>
...
services.<br>
Frutte operates, and processes personal data. Frutte may also transfer such
data to locations other than the one where our users live or use Frutte
services.<br>
We do so in order to fulfill our agreements with users, such as our Terms of
Use, or based on users’ prior consent, adequacy decisions for the relevant
locations.</span></p>
...
creation.<br>
Created during use of our services, such as location, app usage, and device
data.<br>
...
may include feedback, photographs or other information collected by users,
including picture , written format )submitted by users in connection with
...
(A) When users manually input their information in the app<br>
(B) If authorized by users to access their Gmail accounts, from travel-related
email confirmations. If so authorized, Frutte will only access users’ Gmail
accounts to collect tracking information to enable the Frutte Travel feature,
and will adhere to Google’s API Services User Data Policy, including the
limitations on use of data collected from users’ Gmail accounts.<br>
(C) Data created during use of our services.<br>
This includes:<br>
I) Location data (Delivery recipients): We collect delivery recipients data on
precise or approximate location data to enable and enhance use of our apps,
including to improve pick-ups, facilitate deliveries, enable safety features,
and prevent and detect fraud.<br>
We collect such data from user’s mobile devices if they enable us to do so.<br>
&nbsp;“Choice and transparency” is briefly described on how riders and delivery
recipients can enable location data collection. Frutte collects such data from
the time a ride or delivery is requested until it is finished (and may indicate
such collection via an icon or notification on your mobile device depending on
your device’s operating system), and any time the app is running in the
...
For example, a user who has not enabled location data collection will have to
manually enter their pick-up address. In addition, the location data collected
from a driver during a trip will be linked to the rider’s account, even if the
rider has not enabled location data to be collected from their device,
including for purposes of receipt generation, customer support, fraud
...
location and amount of transaction), delivery information, date and time the
service was provided, amount charged, distance traveled, and payment method.
Additionally, if someone uses your promotion code, we may associate your name
...
each other (generally without disclosing their telephone numbers to each
other).<br>
To provide this service, Frutte receives some data regarding the calls, texts,
or other communications, including the date and time of the communications and
the content of the communications. Uber may also use this data for customer
support services (including to resolve disputes between users), for safety and
...
fare splitting, ETA sharing, and ratings and compliments), and accessibility
features to facilitate use of our services by those with disabilities<br>
process payments.<br>
3) Track and share the progress of rides or deliveries<br>
4) Personalize user’s accounts. We may, for example, present a Frutte user with
...
4)Delivering and measuring the effectiveness of advertising campaigns.<br>
5)Analyzing site traffic and trends, and generally understanding the online
