            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  SizedBox(width: 15,),
                  Text('Congratulations!',style: TextStyle(fontSize: 24,fontWeight: FontWeight.w500),)
                ],
              ),
              SizedBox(height: 10,),
              Text('Your mobile number verified successfully!',style: TextStyle(fontSize: 12,fontWeight: FontWeight.w600),),
              SizedBox(height: 10,),
              Divider(
              ...
              SizedBox(height: 25,),
              Text('One Last Step',style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,letterSpacing: 0.2),),
              Padding(
