            ...
            return Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                      ...
                      children: [
                        TextWidget("Pick your Address", textType: "subheading"),
                        SizedBox(height: 10),
                        Divider(),
                        SizedBox(height: 10),
                        new Expanded(
                                ...
                                return Padding(
                                  ...
                                  child: ListTile(
                                      ...
                                      subtitle: TextWidget(
                                          ...
                                          textType: "para"),
                                      trailing: (MyApp.addresses.length <= 1)
                                          ? SizedBox()
                                          : (MyApp.selectedAddressId == i)
                                              ? SizedBox()
                                              : IconButton(
                                      ...
                                      onTap: () async {
                                        ...
                                        if (resp[0] == 200) {
                                          if (resp[1]['available_item_count'] !=
                                              resp[1]['total_item_count']) {
                                            return showDialog(
