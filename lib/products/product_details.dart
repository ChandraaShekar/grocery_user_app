...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:Header.appBar('Product Details',Row(
        children: [
          GestureDetector(
            onTap: (){
      ...
      body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text('Capsicum - Red/Bengalur Mirapakayi/Shimla Mirchi',style: TextStyle(fontWeight:FontWeight.w600),),
              ),
              Padding(
                padding: const EdgeInsets.only(left:8.0,right: 8,bottom: 8),
                child: Row(children: [
                  Text(Constants.rupeeSymbol+" 250",style: TextStyle(fontWeight: FontWeight.w600),),
                  SizedBox(width:15),
                  Text('MRP: '+Constants.rupeeSymbol),
                  Text("285",style:TextStyle(decoration: TextDecoration.lineThrough)),
                  SizedBox(width: 10,),
                  Container(
       ...
       child: Padding(
        ...
        child: Text("25% OFF",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600),),
      ),
     ),
    ...
    Container(
      decoration: BoxDecoration(
       ...
       child: Padding(
        padding: const EdgeInsets.all(4.0),
        child: Text("1 KG",style: TextStyle(fontWeight: FontWeight.w600),),
      ),
     )
                ],),
              ),
         ...
         Text('Quantity',style: TextStyle(fontWeight: FontWeight.w700,color: Colors.grey),),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: CounterBtn(
                      incDecheight: 40,
         ...
         Container(
           child: Padding(
             ...
             child: Column(
               ...
               children: [
                 Text('Description',style: TextStyle(fontWeight: FontWeight.w700,color: Colors.grey),),
                  Padding(
                      padding: const EdgeInsets.only(top:10.0,bottom: 10.0),
                      child: Text("Organic seedless lemon will enhance the flavor of all your favorite recipes, including chicken, fish, vegetables."),
                 ),
                Text('Other Product Info',style: TextStyle(fontWeight: FontWeight.w700,color: Colors.grey),),
                SizedBox(height: 10,),
                Text('EAN Code: '+code),
                Text('Country of Origin: '+country),
                Text('Sourced & Marketed By: '+company),
                SizedBox(height:10),
                Text('Recommended Products',style: TextStyle(fontWeight: FontWeight.w700,color: Colors.grey),),
               ],
             ),
           ),
         ),
