...
class Constants {
  ...
  static final  sideHeading2 = TextStyle(fontWeight: FontWeight.w600,fontSize: 18);
...
static final sideHeading = new TextStyle(
  ...
  static final Color topLeftCircleColor =const Color(0xffFFF48F).withOpacity(0.51);
  static final Color topRightCircleColor =const Color(0xffEEE0F8);
  static final Color bottomLeftCircleColor =const Color(0xff82CCFB).withOpacity(0.35);
  ...
  static final Color qtyBgColor=Colors.grey[200];
